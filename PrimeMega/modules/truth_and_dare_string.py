TRUTH = (
   ...
   "Pernah bosen nafas gak?",
   "Di gc ini siapa yang paling kamu benci?",
   "Di gc ini siapa yang kamu mau ajak fwb an?",
   "Di gc ini siapa yang paling kamu sayang?",
   "Di gc ini siapa yang pernah chat kamu?",
   "Di gc ini siapa yang kamu suka?",
)
