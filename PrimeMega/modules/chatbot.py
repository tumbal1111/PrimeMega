...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        response = response.replace("luna", "wiki")
        response = response.replace("I'm a Christian", "My god is @terserah_wiki")
        ...
        response = response.replace("I'm married to my job.", "I'm married with @terserah_wiki")
        response = response.replace("I'm single.", "My husband is @terserah_wiki")
        response = response.replace("Wikibot.ai", "@virtcirclee")
...
@pbot.on_message(filters.regex("Wiki|WIKI|wik|wikwik|Wik|wiki") & ~filters.bot & ~filters.via_bot  & ~filters.forwarded & ~filters.reply & ~filters.channel & ~filters.edited)
async def inuka(client, message):
    msg = message.text
    if msg.startswith("/") or msg.startswith("@"):
        message.continue_propagation()
